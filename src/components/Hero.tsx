    ...
    <section className="relative min-h-[90vh] sm:min-h-[80vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="/images/hero.png"
          alt="Michael & Danitza"
          className="w-full h-full object-cover object-[center_70%] sm:object-center scale-135 sm:scale-100"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/10 to-paper-100"></div>
      </div>

      {/* Content */}
      <div className="relative h-full min-h-[90vh] sm:min-h-[80vh] flex flex-col items-center justify-end pb-6 sm:pb-16 px-4">
        <div className="text-center animate-fade-up">
          <p className="font-script text-palo-rosa-50 text-2xl sm:text-3xl mb-4 drop-shadow-[0_4px_12px_rgba(0,0,0,0.7)] font-semibold">
            Nos casamos
          </p>
          <h1 className="font-display font-bold text-5xl sm:text-7xl text-gray-800 mb-3 drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
            Michael <span className="text-palo-rosa-50 text-6xl sm:text-8xl drop-shadow-[0_4px_12px_rgba(0,0,0,0.7)]">&</span> Danitza
          </h1>
          <div className="flex items-center justify-center gap-4 my-6">
            <div className="w-20 sm:w-24 h-0.5 bg-palo-rosa-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]"></div>
            <svg className="w-6 h-6 sm:w-7 sm:h-7 text-palo-rosa-50 drop-shadow-[0_4px_10px_rgba(0,0,0,0.7)]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="sm:hidden mt-8 animate-bounce">
            <svg className="w-6 h-6 mx-auto text-palo-rosa-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
